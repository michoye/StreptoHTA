...
# Is Throat Culture More Cost-Effective than Rapid Antigen Diagnostic Testing (RADT) for Treating Group A Streptococcus (GAS) in Pedriatric Sore Throat Patients?

# Background and Objectives

## Study Question

The study evaluates whether **Throat Culture** is more cost-effective than **Rapid Antigen Diagnostic Testing (RADT)** for diagnosing and treating **Group A Streptococcus (GAS)** in pediatric sore throat patients.

### Relevance

-   Throat infections are often viral, yet **antibiotics are frequently overprescribed**, contributing to antibiotic resistance.
...
Several existing models evaluate diagnostic strategies using **rapid strep tests** and analyze the **cost-effectiveness of treatment options**. Examples include:
